...
from transformers import BertModel, BertTokenizer, Qwen2Tokenizer, Qwen2VLForConditionalGeneration, T5EncoderModel, T5Tokenizer, T5TokenizerFast, UMT5EncoderModel, AutoTokenizer
...
def main():
    ...
    flow_shift = 3.0
    noise_scheduler = UniPCMultistepScheduler(prediction_type='flow_prediction', use_flow_sigmas=True, num_train_timesteps=1000, flow_shift=flow_shift)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for _ in range(num_update_steps_per_epoch):
            ...
            with accelerator.accumulate(transformer3d):
                ...
                sampled_latents = sampled_latents / latents_std + latents_mean
